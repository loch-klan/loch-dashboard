...
class BackTestPageMobile extends BaseReactComponent {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
...
BackTestPageMobile.propTypes = {};
export default connect(mapStateToProps, mapDispatchToProps)(BackTestPageMobile);
