...
class ProfileForm extends BaseReactComponent{
    ...
    constructor(props) {
        ...
        this.state = {
          ...
          link:
            userDetails?.link || localStorage.getItem("lochDummyUser") || "",
    ...
    onValidSubmit = () => {
        ...
        if (this.state.prevfirstName !== this.state.firstName) {
           FirstNameAdded({session_id: getCurrentUser().id, email_address: this.state.email, first_name: this.firstName});
        //   console.log(
        //     "prev fName",
        ...
        if (this.state.prevemail !== this.state.email || this.state.prevemail === "" && this.state.email !== "") {
          EmailAdded({
            session_id: getCurrentUser().id,
            ...
            <div className="form">
              <Form onValidSubmit={this.onValidSubmit}>
                ...
                <Button
                  ...
                  type="submit"
                  onClick={()=> ProfileSaved({email_address: getCurrentUser().email, session_id: getCurrentUser().id})}
                >
                  Save changes
                </Button>
              </Form>
