...
class EmulationTransactionsPageMobile extends BaseReactComponent {
  constructor(props) {
    super(props);
    this.state = {};
  }
  ...
  render() {
    return (
      <div className="assets-expanded-mobile expanded-mobile">
        ...
        >
          <h4>
            {this.props.passedAddress
              ? `Transactions for ${this.props.passedAddress}`
              : "Transactions"}
          </h4>
          <p>
            {this.props.passedAddress
...
EmulationTransactionsPageMobile.propTypes = {};
