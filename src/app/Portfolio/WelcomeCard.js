            ...
            <div className="welcome-card">
                <div className="welcome-card-upper-section">
                    <div className='welcome-section-left'>
                        ...
                        <p className='inter-display-medium'>Add your wallet address(es) to receive </p>
                        <p className="inter-display-medium m-b-24"> personalized financial intelligence immediately.</p>
                ...
                <div className="welcome-btn">
                        ...
                        >
                            <Image src={props.toggleAddWallet===true?AddWalletAddress:AddWalletAddressWhite}/>
                            Add wallet address
                        </Button>
                </div>
            </div>
