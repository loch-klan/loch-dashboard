...
class Portfolio extends BaseReactComponent {
  ...
  render() {
    ...
    const CounterPartiesColumnData = [
      {
        labelName: (
    ...
    if (this.state.isMobileDevice) {
      return (
        ...
        >
          ...
          <PortfolioMobile
            CounterPartiesColumnData={CounterPartiesColumnData}
            ...
            <div className="portfolio-container page-scroll">
              <div className="page-scroll-child page-scroll-child-full-width">
                ...
                <div className="m-b-22 graph-table-section">
                  <Row>
                    <Col style={{ width: "calc( 50% - 0rem )" }} md={6}>
                      <div
                                  ...
                                  >
                                    {this.state.localNftData
                                      ? this.state.localNftData?.length > 10
                                        ? `Click here to see ${numToCurrency(
                                            this.state.localNftData?.length -
                                              10,
                                            true
                          ...
                          <div>
                            ...
                            >
                              <TransactionTable
                                ...
                                showDataAtBottom
                                columnList={CounterPartiesColumnData}
                                headerHeight={60}
                                isArrow={true}
                            ...
                            {!this.state.counterGraphLoading ? (
                              <div className="inter-display-medium bottomExtraInfo">
                                <div
                                  onClick={this.goToCounterPartyVolumePage}
                                  className="bottomExtraInfoText"
                                >
                                  Click here to see more
                                </div>
