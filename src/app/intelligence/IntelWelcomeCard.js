    ...
    <div className="m-b-60 intell-welcome-card">
      ...
      <div className="row-card">
        ...
        <div className="welcome-card">
          <h3 className="inter-display-semi-bold f-s-20 lh-24 welcome-card-title ">
            Valuable intelligence,
          </h3>
          <h3 className="inter-display-semi-bold  f-s-20 lh-24 m-b-12 welcome-card-title ">
            personalized to you
          </h3>
          <p className="inter-display-medium f-s-13 lh-16 m-b-32 card-subtitle ">
            Invest smarter with curated insights from your data
          </p>
          <div className="info-container">{cards}</div>
        </div>
      </div>
    </div>
  );
